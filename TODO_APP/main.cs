...
namespace TODO_APP
{
    public partial class main : KryptonForm
    {
        ...
        private void ConfigurarDataGridView()
        {
            ...
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "ID Tarea", DataPropertyName = "TareaID", Name = "TareaID" });
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Nombre Usuario", DataPropertyName = "NombreUsuario", Name = "NombreUsuario" });
            dataGridView1.Columns.Add(new DataGridViewTextBoxColumn { HeaderText = "Nombre Tarea", DataPropertyName = "NombreTarea", Name = "NombreTarea" });
        ...
        private void DeleteSelectedRow()
        {
            try
            {
                if (dataGridView1.SelectedRows.Count > 0)
                {
                    ...
                    {
                        MessageBox.Show("No se pudo eliminar la tarea.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                else
                {
            ...
            {
                MessageBox.Show("Ninguna tarea eliminada \nError text : " + ex.Message);
            }
            finally
            {
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Seleccione una tarea para actualizar.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
